...
docker run --rm --env-file $ENV_FILE -v $UNZIP_DIR:/data $DOCKER_IMAGE \
sh -c '/usr/bin/shp2pgsql -I -s 4326 /data/tl_2023_us_county.shp us_counties > /data/shp2pgsql_output.sql'
