...
// The maplibregl variable is provided by the maplibre-gl script loaded in index.html
...
geolocationControl.on("geolocationSuccess", (position) => {
    ...
    const features = map.querySourceFeatures(config.sourceNames.usCounties, {
    ...
    const foundCounty = features.find((feature) =>
        // The turf variable is provided by the turf script loaded in index.html
